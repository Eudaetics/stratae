...
class DirectBus:
    ...
    def __init__(self, *, use_envelope: bool = False) -> None:
        ...
        self._dispatch: Callable[[object, _AnyEventConfig, None], None] = (
    ...
    def emit(self, payload: object, event: _AnyEventConfig, _config: None = None) -> None:
        """
    ...
    def _dispatch_plain(self, payload: object, event: _AnyEventConfig, _config: None) -> None:
    ...
    def _dispatch_in_envelope(self, payload: object, event: _AnyEventConfig, _config: None) -> None:
        with Envelope.scope():
