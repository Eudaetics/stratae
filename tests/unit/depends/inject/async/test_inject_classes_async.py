...
async def test_class_init_async_dep():
    ...
    class SimpleObject:
        ...
        @classmethod
        @inject
        async def create(cls, value: Annotated[int, Depends(get_async_dep)]) -> Self:
            return cls(value)
...
async def test_nested_async_class_creation():
    ...
    class SimpleObject:
        ...
        @classmethod
        @inject
        async def create(cls, dep: Annotated[DepClass, Depends(get_dep_class)]) -> Self:
            return cls(dep)
...
async def test_method_injection_async():
    ...
    class SimpleObject:
        @inject
        async def set_value(self, value: Annotated[int, Depends(get_async_dep)]):
            self.value = value
...
async def test_static_method_injection_async():
    ...
    class SimpleObject:
        ...
        @staticmethod
        @inject
        async def set_value(value: Annotated[int, Depends(get_async_dep)]):
...
async def test_class_method_injection_async():
    ...
    class SimpleObject:
        ...
        @classmethod
        @inject
        async def set_value(cls, value: Annotated[int, Depends(get_async_dep)]):
            cls.value = value
